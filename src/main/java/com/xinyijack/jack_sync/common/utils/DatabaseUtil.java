...
public final class DatabaseUtil {
    public static boolean entirelyBackup(String dbHost,  String dbUsername, String dbPassword, String dbName, String dbOutputFile, String dbFilename)
    ...
    public static  boolean incrementalBackup(){
        return true;
    }
